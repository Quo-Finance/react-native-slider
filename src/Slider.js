...
export default class Slider extends PureComponent {
  static propTypes = {
    ...
    /**
     * Set this to allow sliding only up to a certain value
     */
    maxSlideValue: PropTypes.number,

    /**
     * Percent of the total width of the slider that the track should take up
     */
    maximumTrackWidth: PropTypes.number,
  };
  ...
  _setCurrentValue = (value: number) => {
    if (
      this.props.maxSlideValue !== null &&
      this.props.maxSlideValue !== undefined &&
      this.props.maxSlideValue < value
    ) {
      this.state.value.setValue(this.props.maxSlideValue);
    } else {
